...
from qiskit.circuit.library import TdgGate, SdgGate, SXdgGate
...
class QiskitCircuitParser:
    ...
    ADJOINTS = (TdgGate, SdgGate, SXdgGate)
    ...
    def parse_operation(
        ...
        if isinstance(instruction, self.ADJOINTS):
            op_dict["isAdjoint"] = True
